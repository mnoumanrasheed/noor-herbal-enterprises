...
export function Footer({ contactSettings = DEFAULT_CONTACT_SETTINGS, footerContent = "Thoughtful pantry and personal care essentials, prepared for everyday rituals." }: FooterProps) {
  ...
  const instagramUrl = contactSettings.instagram || "https://www.instagram.com/noorherbalenterprices?utm_source=qr&stkn=MTZnNnJhdWl1ZXhtMQ%3D";
  const facebookUrl = contactSettings.facebook || "https://www.facebook.com/share/19hy2eDsyq/";
      ...
      <div className="site-shell px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.7fr_1fr_1fr_1.4fr] lg:gap-10">
          ...
          <div>
            ...
            <div className="mt-5 space-y-3 text-sm">
              ...
              <a href={instagramUrl} target="_blank" rel="noreferrer" className="footer-link block">Instagram</a>
              <a href={facebookUrl} target="_blank" rel="noreferrer" className="footer-link block">Facebook</a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-[#312d27] pt-6 text-xs text-[#777169] sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#38332a]">•</span>
            <a
